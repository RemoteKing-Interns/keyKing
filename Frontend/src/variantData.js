  ...
  "Giulia": {
    "2016-2018": {
      vehicleInfo: {
        ...
        silcaTransponder: "4A",
        transponderChip: ["JMA TP12PV", "4A"],
        transponderChipLinks: [
          "https://example.com/transponder/JMA-TP12PV",
          "https://example.com/transponder/4A"
        ],
        remoteFrequency: "433 MHz",
        KingParts: ["AKK260", "AKK263"],
        KingPartsLinks: [
          "https://example.com/kingparts/AKK260",
          "https://example.com/kingparts/AKK263"
        ],
        silcaKeyCutting: ["1077", "6127", "5992 Emergency Blade"],
        Lishi: "LP-HU92-TL-AG",
        LishiLink: "https://example.com/lishi/LP-HU92-TL-AG",
      },
      programmingInfo: [
        {
