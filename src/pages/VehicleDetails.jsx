...
const VehicleDetails = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      <h1 className="text-2xl font-bold mb-2">{vehicle.brand} {vehicle.model} ({vehicle.years})</h1>
      <div className="flex gap-4 mb-4">
        <img src={vehicle.imageUrl} alt="Vehicle" className="w-48 rounded shadow" />
        <img src={vehicle.keyImageUrl} alt="Key Fob" className="w-32 rounded shadow" />
      </div>
      <div className="bg-white rounded shadow p-4 mb-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div><strong>Years:</strong> {vehicle.years}</div>
